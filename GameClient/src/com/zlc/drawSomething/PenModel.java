...
public class PenModel implements Serializable {
	...
	/**
	 * The setPenSize method is to set the pen size
	 */
	...
	/**
	 * The setPenColor method is to set the pen's color
	 */
	...
	/**
	 * The getOy method is to get the oy
	 * 
	 * @return oy
	 */
	public int getOy() {
	...
	/**
	 * The setOxOy method is to set the previous position (ox,oy)
	 */
	...
	/**
	 * The getX method is to return the current position's x
	 * 
	 * @return x
	 */
	public int getX() {
	...
	/**
	 * The setX method is to set the current position's x
	 */
	...
	/**
	 * The setY method is to set the current position's y
	 */
	...
	/**
	 * The setXY method is to set the current pen's position (x,y)
	 * 
	 * @param x
	 * @param y
	 */
