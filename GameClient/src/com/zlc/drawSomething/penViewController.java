...
public class penViewController extends penView {
	...
	/**
	 * The activeControll is a flag to indicate whether the tool can control the
	 * model
	 */
	...
	/**
	 * The getActiveControl method is to get whether the tool is authorized to
	 * control the model model
	 */
	public boolean getActiveControl() {
		return activeControll;
	}

	/** The timeUp method is to set the time'up message */
	public void timeUp() {
		showMessage.timeUp();
	}
	...
	/** The setActiveControl method is to ban the tool to control the model */
